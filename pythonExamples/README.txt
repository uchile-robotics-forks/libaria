...
one document. You can run the Jupyter "kernel" and launch a web browser
to begin a Jupyter project locally, or if your robot has an onboard
computer, you can run the kernel on the onboard computer and users can
work on your notebook and code via a web browser interface on a separate
computer.
...
/usr/local/Aria/pythonExamples/intro.ipynb, run jupyter notebook, then
open intro.ipynb:
